...
public class ElementsTextConstants {
    ...
    public static final String BUSINESS_PAGE_UNIQUE_TEXT = "Зарплатный";
    public static final String FINANCE_PAGE_UNIQUE_TEXT = "Финансовым";
    public static final String INVESTOR_PAGE_UNIQUE_TEXT = "акционеров";
    public static final String VED_PAGE_UNIQUE_TEXT = "ВЭД360";
